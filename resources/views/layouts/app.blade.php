            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                     ...
                     <a href="{{url('/recipes')}}"> Recipe</a>
                     </li>
                     &nbsp; &nbsp;
                     <li class="nav-item" style="display: inline-block;">
                     <a href="{{url('/overviews')}}"> Overview</a>
                     </li>
                    </ul>
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="position:relative;padding-left:50px;" v-pre>
                                    <img src="/uploads/profile_pics/{{ Auth::user()->profile_pic }}" style="width:32px;height:32px;position:absolute;top:10px;left:10px;border-radius:50%">
